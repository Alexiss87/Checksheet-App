...
export const getChecksheets = async () => {
  const response = await fetch(`${url}/checksheets`).catch(error => {
    console.error(error);
  });
...
export const getChecksheet = async id => {
  const response = await fetch(`${url}/checksheets/${id}`).catch(error => {
    console.error(error);
  });
...
export const postChecksheet = async data => {
...
export const getResults = async (params = '') => {
  const response = await fetch(`${url}/results${params}`).catch(error => {
    console.error(error);
  });
...
export const getResult = async id => {
  const response = await fetch(`${url}/results/${id}`).catch(error => {
    console.error(error);
  });
...
export const getChecks = async (params = '') => {
  const response = await fetch(`${url}/checks${params}`).catch(error => {
    console.error(error);
  });
